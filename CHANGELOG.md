...
- Paper Reading v4：分页模式页面卡片右侧增加微卷页边阴影，iOS 翻页触发轻触感反馈，macOS 翻页从淡入淡出改为带方向性的滑入滑出过渡，整体动势更贴近真实翻书。
### Fixed
...
- Added a manual ReaderMemory compression pass that folds clustered saved
